        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <input
                className={`appearance-none block w-full bg-[#fefefed4] text-gray-700 border ${isEmailValid ? '' : 'border-red-500'
                  } rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white ${isEmailValid ? '' : 'focus:border-red-500'
                  }`}
                id="email"
                type="email"
          ...
          <button
            type="submit"
            className={`bg-[#ff00588a] hover:bg-[#ff0058e3] text-white font-bold mt-8 py-2 px-4 rounded ${isFormValid ? '' : 'opacity-50 cursor-not-allowed'
