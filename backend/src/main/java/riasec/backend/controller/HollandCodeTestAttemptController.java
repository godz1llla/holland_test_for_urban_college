...
public class HollandCodeTestAttemptController {
    ...
    public ResponseEntity<Map<String, List<?>>> processAnswers(@RequestBody Map<String, Object> requestData) {
        try {
            // Prepare Data
            Map<String, Boolean> answersJson = (Map<String, Boolean>) requestData.get("questionAnswer");
            ...
            // Convert Map<String, Boolean> to Map<HollandCodeTestQuestion, Boolean>
            ...
            Optional<HollandCodeTest> hollandCodeTest = hollandCodeTestRepository
                    .findById(Long.parseLong(String.valueOf(requestData.get("testId"))));
